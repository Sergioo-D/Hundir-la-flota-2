...
def crear_ventana():
    ...
    # Importa las funciones justo antes de usarlas
    from funciones import registraUsuario, primerFrame, segundoFrame, partidaEmpezada
    ...
    ventana.botonStart = tkinter.Button(ventana,text="Empezar partida",state=tkinter.DISABLED,command=lambda:partidaEmpezada(ventana), width=20)
